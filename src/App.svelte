		...
		<tbody>
			{#if productType === 'media'}
				...
				<tr>
					...
					<td>{price <= 500 ? percentage(9, price) : percentage(12, price)}</td>
					<td>{closingFees}</td>
					<td>{handlingFees}</td>
					<td>
			...
			{:else if productType === 'fashion'}
				...
				<tr>
					<td>
						Apparel: Men's T-Shirt (except Polos, Tank Tops & Full Sleeve Tops)
					</td>
				...
				<tr>
					...
					<td>{closingFees}</td>
					<td>{handlingFees}</td>
					<td>{price + closingFees + handlingFees + percentage(2.5, price)}</td>
					<td>
			...
			{:else if productType === 'kitchen'}
				...
				<tr>
					...
					<td>{closingFees}</td>
					<td>{handlingFees}</td>
					<td>{price + closingFees + handlingFees + percentage(11, price)}</td>
					<td>
						{percentage(18, closingFees + handlingFees + percentage(11, price))}
					</td>
					<td>
				...
				<tr>
					...
					<td>{price <= 300 ? percentage(7, price) : percentage(10, price)}</td>
					<td>{closingFees}</td>
					<td>{handlingFees}</td>
					<td>
			...
			{:else if productType === 'electronics'}
				...
				<tr>
					<td>
						Musical Instruments: DJ & VJ Equipment, Recording & Computer, Cables
						& Leads, Microphones, PA & Stage
					</td>
					<td>{percentage(8, price)}</td>
					<td>{closingFees}</td>
					<td>{handlingFees}</td>
